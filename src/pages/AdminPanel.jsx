...
export default function AdminPanel() {
  ...
  async function copySiteUrl(
    ...
    const fullUrl =
      `${window.location.origin}${getPublicSiteUrl(client)}`;
...
${window.location.origin}${getPublicSiteUrl(client)}`;
    ...
    try {
      ...
      alert(
        "Acceso cliente copiado 🔥"
      );

    } catch {

      alert(
        "Error copiando acceso"
      );
    }
  }
              ...
              (client) => (
                ...
                >
                  ...
                  <input
                    ...
                    readOnly
                    value={`${window.location.origin}${getPublicSiteUrl(client)}`}
                  />
