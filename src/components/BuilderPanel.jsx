...
export function BuilderPanel({
  ...
  function handleHeroBackground(file) {
    ...
    reader.onload = () => {
      updateDesign("heroBackground", reader.result);

      updateDesign(
        "heroBackgroundName",
        file.name || "fondo-hero.jpg"
      );
    };
  ...
  function removeHeroBackground() {
    updateDesign("heroBackground", "");
    updateDesign("heroBackgroundName", "");
  }
  ...
  function loadProject(file) {
    ...
    reader.onload = () => {
      try {
        ...
        alert(
          "Ese archivo no parece un proyecto válido."
        );
      }
    };
    ...
    <aside className="panel">
      ...
      <section className="panelSection">
        ...
        <label>
          ...
          >
            <option value="global">
              Un solo fondo para toda
              la web
            </option>

            <option value="perPage">
              Fondo diferente por cada
              página
            </option>
          </select>
        </label>
